...
DWORD  *padrK32a[] = 
{
	(DWORD*)&_GetModuleHandle, 
	(DWORD*)&_LoadLibrary
}; // &_GetTickCount,


char kernel32aStr[] = "/*@S|*/00GetModuleHandleA|01LoadLibraryA/*@E*/|";

void InitKernel32a()
{
	InitAPIbyStr(padrK32a, _KERNEL32, kernel32aStr); // 01GetTickCount|
